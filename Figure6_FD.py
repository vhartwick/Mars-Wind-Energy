...
dataDIR = '/lou/la2/vhartwic/analysis/papers/windenergy/Hartwick2022/Data/Figure6.nc'
...
fig2 = ax4.contourf(DDS_PCT.lon, DDS_PCT.lat, DDS_PCT.percent_wind24_ls270*100, levels=levels, colors='#8a226a')
fig2 = ax4.contourf(DDS_PCT.lon, DDS_PCT.lat, DDS_PCT.percent_wind24_ls90*100, levels=levels, colors='#f98e09')
