...
# ========================================================
# Open Data Files
dataDIR = '/lou/la2/vhartwic/FV3/verona/fv3_2.0_windenergy/fms_mars_MY24_highres/history/02094.fixed.nc'
DS_fixed = xr.open_dataset(dataDIR, decode_times=False)

dataDIR = '/lou/la2/vhartwic/FV3/verona/fv3_2.0_windenergy/fms_mars_MY24_highres/history/*.atmos_diurn_MY24.nc'
...
var8 = xr.DataArray(rho, coords={'lon': DDS.lon, 'lat': DDS.lat,'time': DDS.time, 'time_of_day_24': DDS.time_of_day_24, 'zagl': DDS.zagl},dims=['time','time_of_day_24','zagl','lat','lon'])
var8.name = 'rho'

NEW_DF = xr.merge([var1, var2, var3, var4,var5,var6,var7,var8])
NEW_DF.to_netcdf('/lou/la2/vhartwic/FV3/verona/fv3_2.0_windenergy/fms_mars_MY24_highres/history/MY24_highres_savefile.nc')


# Calculate Power [W or kW]  for Each Turbine Using Power Curve
# Enercon E33
...
# use atmospheric average file for short wave solar surface energy flux [W/m2]
print('Output MY24 Power Calculation')
...
NEW_DF.to_netcdf('/lou/la2/vhartwic/FV3/verona/fv3_2.0_windenergy/fms_mars_MY24_highres/history/MY24_highres_pow.nc')


# ========================================================
# Analysis of MY28
# ========================================================
print("Opening MY28 Data")
dataDIR = '/lou/la2/vhartwic/FV3/verona/fv3_2.0_windenergy/fms_mars_MY28_highres/history/02094.fixed.nc'
DS_fixed = xr.open_dataset(dataDIR, decode_times=False)

dataDIR = '/lou/la2/vhartwic/FV3/verona/fv3_2.0_windenergy/fms_mars_MY28_highres/history/*.atmos_diurn_MY28.nc'
DDS = xr.open_mfdataset(dataDIR, decode_times=False,combine='by_coords')
...
var7 = xr.DataArray(veladj, coords={'lon': DDS.lon, 'lat': DDS.lat,'time': DDS.time, 'time_of_day_24': DDS.time_of_day_24, 'zagl': DDS.zagl},dims=['time','time_of_day_24','zagl','lat','lon'])
var7.name = 'veladj'

NEW_DF = xr.merge([var1, var2, var3, var4,var5,var6,var7])
NEW_DF.to_netcdf('/lou/la2/vhartwic/FV3/verona/fv3_2.0_windenergy/fms_mars_MY28_highres/history/MY28_highres_savefile.nc')

# ==============================================================
# Calculate Percent Time Wind/Solar/Total Enercon E33 &
# 2500m2 Solar Array
# ==============================================================
print("Calculating Percent Time Wind/Solar/Total Enercon E33 & 2500m2 Solar Array")
...
count_wind24,count_solar2500,count_total2500 = np.zeros((len(DDS_MY24.lat),len(DDS_MY24.lon))),np.zeros((len(DDS_MY24.lat),len(DDS_MY24.lon))),np.zeros((len(DDS_MY24.lat),len(DDS_MY24.lon)))
for i in range(0,len(DDS_MY24.lat)):
    print(i)
    for j in range(0,len(DDS_MY24.lon)):
        count_wind24[i,j] = np.count_nonzero(DDS_MY24.pow_diurn_E33[:,:,i,j] >=24)
...
percent_wind24 = count_wind24/time
percent_solar2500 = count_solar2500/time
percent_total2500 = count_total2500/time

# Save variables
var1 = xr.DataArray(percent_wind24, coords={'lon': DDS_MY24.lon, 'lat': DDS_MY24.lat}, dims=['lat','lon'])
var1.name = 'percent_wind24'
var2 = xr.DataArray(percent_solar2500, coords={'lon': DDS_MY24.lon, 'lat': DDS_MY24.lat},dims=['lat','lon'])
var2.name = 'percent_solar2500'
var3 = xr.DataArray(percent_total2500, coords={'lon': DDS_MY24.lon, 'lat': DDS_MY24.lat},dims=['lat','lon'])
var3.name = 'percent_total2500'

NEW_DF = xr.merge([var1,var2,var3])
NEW_DF.to_netcdf('/lou/la2/vhartwic/FV3/verona/fv3_2.0_windenergy/fms_mars_MY24_highres/history/MY24_highres_solarwindpercent2500.nc')
...
# ==============================================================
#
print("Calculate Percent Time Wind/Solar/Total Alternative Turbine & 2500m2 Solar Array")
...
NEW_DF.to_netcdf('/lou/la2/vhartwic/FV3/verona/fv3_2.0_windenergy/fms_mars_MY24_highres/history/MY24_highres_solarwindpercent2500_altturb.nc')

#==============================================================
# Percent Time Wind/Solar Enercon E33 & 300m2 Solar Array
#==============================================================
print("Percent Time Wind/Solar Enercon E33 & 300m2 Solar Array")
...
NEW_DF = xr.merge([var1,var2,var3])
NEW_DF.to_netcdf('/lou/la2/vhartwic/FV3/verona//fv3_2.0_windenergy/fms_mars_MY24_highres/history/MY24_highres_solarwindpercent300.nc')
