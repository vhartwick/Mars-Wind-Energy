...
# diurnal mean
tmp_SY1 = DDS_MY24.pow_diurn_E33.mean('time_of_day_24')
...
for i in range(0,len(DDS_MY24.lat)):
    for j in range(0,len(DDS_MY24.lon)):
        ...
        if np.any(tmp_ls90 < 24):
            ...
            lat_sav24_ls90+= [DDS_MY24.lat[i]]
            lon_sav24_ls90 +=[DDS_MY24.lon[j]]
...
for i in range(0,len(DDS_MY24.lat)):
    for j in range(0,len(DDS_MY24.lon)):
        ...
        if np.any(tmp_ls270 < 24):
            ...
            lat_sav24_ls270+= [DDS_MY24.lat[i]]
            lon_sav24_ls270 +=[DDS_MY24.lon[j]]
...
for i in range(0,len(DDS_MY24.lat)):
    for j in range(0,len(DDS_MY24.lon)):
        ...
        if np.any(tmp_ls90 < 15):
            ...
            lat_sav15_ls90+= [DDS_MY24.lat[i]]
            lon_sav15_ls90 +=[DDS_MY24.lon[j]]
...
for i in range(0,len(DDS_MY24.lat)):
    for j in range(0,len(DDS_MY24.lon)):
        ...
        if np.any(tmp_ls270 < 15):
            ...
            lat_sav15_ls270+= [DDS_MY24.lat[i]]
            lon_sav15_ls270 +=[DDS_MY24.lon[j]]
...
for i in range(0,len(DDS_MY24.lat)):
    for j in range(0,len(DDS_MY24.lon)):
        ...
        if np.any(tmp_ls90 < 2):
            ...
            lat_sav2_ls90+= [DDS_MY24.lat[i]]
            lon_sav2_ls90 +=[DDS_MY24.lon[j]]
...
for i in range(0,len(DDS_MY24.lat)):
    for j in range(0,len(DDS_MY24.lon)):
        ...
        if np.any(tmp_ls270 < 2):
            ...
            lat_sav2_ls270+= [DDS_MY24.lat[i]]
            lon_sav2_ls270 +=[DDS_MY24.lon[j]]

# 2. Then by day/night
# genesate day and night masks
tmp = DDS_MY24.pow_diurn_E33.sel(time_of_day_24=slice(0,8))
tmp2 = DDS_MY24.pow_diurn_E33.sel(time_of_day_24=slice(18,24))
night = xr.concat([tmp,tmp2],dim='time_of_day_24')
E33_night = night.mean('time_of_day_24')
...
for i in range(0,len(DDS_MY24.lat)):
    for j in range(0,len(DDS_MY24.lon)):
        ...
        if np.any(tmp_ls90 < 24):
            ...
            lat_sav24_ls90pm+= [DDS_MY24.lat[i]]
            lon_sav24_ls90pm +=[DDS_MY24.lon[j]]
...
for i in range(0,len(DDS_MY24.lat)):
    for j in range(0,len(DDS_MY24.lon)):
        ...
        if np.any(tmp_ls270 < 24):
            ...
            lat_sav24_ls270pm+= [DDS_MY24.lat[i]]
            lon_sav24_ls270pm +=[DDS_MY24.lon[j]]
...
for i in range(0,len(DDS_MY24.lat)):
    for j in range(0,len(DDS_MY24.lon)):
        tmp_ls90 = tmp_SY1[ls90,i,j]
        if np.any(tmp_ls90 < 14.2):
            continue
        else:
            lat_sav15_ls90pm+= [DDS_MY24.lat[i]]
            lon_sav15_ls90pm +=[DDS_MY24.lon[j]]

for i in range(0,len(DDS_MY24.lat)):
    for j in range(0,len(DDS_MY24.lon)):
        tmp_ls270 = tmp_SY1[ls270,i,j]
        if np.any(tmp_ls270 < 14.2):
            continue
        else:
            lat_sav15_ls270pm+= [DDS_MY24.lat[i]]
            lon_sav15_ls270pm +=[DDS_MY24.lon[j]]
...
for i in range(0,len(DDS_MY24.lat)):
    for j in range(0,len(DDS_MY24.lon)):
        ...
        if np.any(tmp_ls90 < 2):
            ...
            lat_sav2_ls90pm+= [DDS_MY24.lat[i]]
            lon_sav2_ls90pm +=[DDS_MY24.lon[j]]
...
for i in range(0,len(DDS_MY24.lat)):
    for j in range(0,len(DDS_MY24.lon)):
        ...
        if np.any(tmp_ls270 < 2):
            ...
            lat_sav2_ls270pm+= [DDS_MY24.lat[i]]
            lon_sav2_ls270pm +=[DDS_MY24.lon[j]]
...
# panel a - Ls90
fig1 = ax1.contourf(DDS_MY24.lon, DDS_MY24.lat, DDS.zsurf/1000, 20,cmap=py.cm.Greys_r)
...
#ax1.plot(lon_sav2_ls90, lat_sav2_ls90, 'ok', markersize=5,fillstyle='none', label='>2.2kW')
ax1.plot(lon_sav15_ls90, lat_sav15_ls90, 'vk', markersize=10, markerfacecolor='blue',label='>14.2kW')
ax1.plot(lon_sav24_ls90, lat_sav24_ls90, 'sk', markersize=10, markerfacecolor='red', label='>24kW')

# panel b - Ls270
fig2 = ax2.contourf(DDS_MY24.lon, DDS_MY24.lat, DDS.zsurf/1000, 20,cmap=py.cm.Greys_r)
clb=py.colorbar(fig2,ax=ax2)
clb.set_label('[km]')
ax2.set_title('(b) $\ L_{s}=270\degree$')
# add landing sites
ax2.plot(longitude, latitude, 'o',markerfacecolor='green',label='ROIs')
#ax2.plot(lon_sav2_ls270, lat_sav2_ls270, 'ok', markersize=5,fillstyle='none', label='>2.2kW')
ax2.plot(lon_sav15_ls270, lat_sav15_ls270, 'vk', markersize=10, markerfacecolor='blue',label='>14.2kW')
ax2.plot(lon_sav24_ls270, lat_sav24_ls270, 'sk', markersize=10, markerfacecolor='red', label='>24kW')

# panel c - nighttime Ls90
fig3 = ax3.contourf(DDS_MY24.lon, DDS_MY24.lat, DDS.zsurf/1000, 20,cmap=py.cm.Greys_r)
...
#ax3.plot(lon_sav2_ls90pm, lat_sav2_ls90pm, 'ok', markersize=5,fillstyle='none', label='>2.2kW')
ax3.plot(lon_sav15_ls90pm, lat_sav15_ls90pm, 'vk', markersize=10, markerfacecolor='blue',label='>14.2kW')
ax3.plot(lon_sav24_ls90pm, lat_sav24_ls90pm, 'sk', markersize=10, markerfacecolor='red', label='>24kW')

# panel d - night, Ls270
fig4 = ax4.contourf(DDS_MY24.lon, DDS_MY24.lat, DDS.zsurf/1000., 20,cmap=py.cm.Greys_r)
...
#ax4.plot(lon_sav2_ls270pm, lat_sav2_ls270pm, 'ok', markersize=5,fillstyle='none', label='>2.2kW')
ax4.plot(lon_sav15_ls270pm, lat_sav15_ls270pm, 'vk', markersize=10, markerfacecolor='blue',label='>14.2kW')
ax4.plot(lon_sav24_ls270pm, lat_sav24_ls270pm, 'sk', markersize=10, markerfacecolor='red', label='>24kW')

py.savefig(f'{PATH}/WindEnergy_HighRes_FigS{ct}.eps',dpi=300)


#Send out Data
NEW_DF = xr.Dataset({'lon_sav15_ls90': lon_sav15_ls90,'lat_sav15_ls90':lat_sav15_ls90,
	'lon_sav24_ls90':lon_sav24_ls90,'lat_sav24_ls90':lat_sav24_ls90,
	'lon_sav15_ls270':lon_sav15_ls270,'lat_sav15_ls270':lat_sav15_ls270,
	'lon_sav24_ls270':lon_sav24_ls270,'lat_sav24_ls270':lat_sav24_ls270,
	'lon_sav15_ls90pm':lon_sav15_ls90pm,'lat_sav15_ls90pm':lat_sav15_ls90pm,
	'lon_sav24_ls90pm':lon_sav24_ls90pm,'lat_sav24_ls90pm':lat_sav24_ls90pm,
	'lon_sav15_ls270pm':lon_sav15_ls270pm,'lat_sav15_ls270pm':lat_sav15_ls270pm,
	'lon_sav24_ls270pm':lon_sav24_ls270pm,'lat_sav24_ls270pm':lat_sav24_ls270pm,
	'zsurf':DDS.zsurf})
