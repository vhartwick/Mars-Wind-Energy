...
fig4 = ax4.contourf(DDS_MY24.lon, DDS_MY24.lat, DDS_MY24.zsurf/1000, 20,cmap=py.cm.Greys)
clb=py.colorbar(fig4,ax=ax4)
clb.set_label('[km]')
fig = ax4.contour(DDS_MY24.lon, DDS_MY24.lat, DDS_MY24.annual_ave_pow_E33, colors=colors, levels=level_lim)
py.clabel(fig, fontsize=9,inline=1, fmt='%1.0f')

ax4.plot(DDS_MY24.lon_sav2, DDS_MY24.lat_sav2, 'ok', markersize=10,fillstyle='none', label='>2.2kW')
ax4.plot(DDS_MY24.lon_sav15, DDS_MY24.lat_sav15, 'vk', markersize=15, markerfacecolor='blue',label='>14.2kW')
ax4.plot(DDS_MY24.lon_sav24, DDS_MY24.lat_sav24, 'sk', markersize=15, markerfacecolor='red', label='>24kW')
