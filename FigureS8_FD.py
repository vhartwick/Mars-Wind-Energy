...
dataDIR = /lou/la2/vhartwic/analysis/papers/windenergy/Hartwick2022/Data/FigureS8.nc'
...
fig1 = ax[0].contourf(DDS_MY24.areo_MY28[:,0].squeeze()-360*3,DDS_MY24.lat,DDS_MY24.taudust_VIS_MY28.mean('lon').transpose(),levels=levels, cmap=py.cm.plasma)
...
fig2 = ax[1].contourf(DDS_MY24.areo_MY28[:,0].squeeze()-360*3, DDS_MY24.lat, DDS_MY24.taudust_VIS_MY28.mean('lon').transpose(),levels=levels, cmap=py.cm.plasma)
