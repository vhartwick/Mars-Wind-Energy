...
axs[0].plot(percent_time_ls90_SY1, percent_max_gave, linewidth=2, label='Ls90')
axs[0].plot(percent_time_ls180_SY1, percent_max_gave, linewidth=2, label='Ls180')
axs[0].plot(percent_time_ls270_SY1, percent_max_gave, linewidth= 2, label='Ls270')
axs[0].plot(percent_time_ls0_SY1, percent_max_gave, linewidth=2, label='Ls0')
axs[0].set_ylim([0,20])
...
fig = axs[1].plot(percent_time_gave_SY1,percent_max_gave, linewidth=2, label='Annual Average')
...
axs[2].plot(ls0_PM, percent_max_PM, 'green', label='Ls0')
axs[2].plot(ls90_PM, percent_max_PM, 'orange', label='Ls90')
axs[2].plot(ls180_PM,percent_max_PM, 'red', label='Ls180')
axs[2].plot(ls270_PM, percent_max_PM, 'purple', label = 'Ls270')
axs[2].set_ylim([0,80])
...
axs[3].plot(ls0_IL, percent_max_PM, 'green', label='Ls0')
axs[3].plot(ls90_IL, percent_max_PM, 'orange', label='Ls90')
axs[3].plot(ls180_IL,percent_max_PM, 'red', label='Ls180')
axs[3].plot(ls270_IL, percent_max_PM, 'purple', label = 'Ls270')
axs[3].set_ylim([0,80])
axs[3].grid(b=None,which='major', axis='both')
