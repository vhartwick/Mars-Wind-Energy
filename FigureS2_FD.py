...
dataDIR = /lou/la2/vhartwic/analysis/papers/windenergy/Hartwick2022/Data/FigureS2.nc'
...
for i in range(6):
        cs = axs[0,i].contourf(DDS_MY24.lon,DDS_MY24.lat,DDS_MY24.wpd_diurn_ave_MY24.sel(zagl=50,time_of_day_24=i+0.5),levels=levels,cmap=py.cm.viridis)
...
for i in range(6):
        cs = axs[1,i].contourf(DDS_MY24.lon,DDS_MY24.lat,DDS_MY24.wpd_diurn_ave_MY24.sel(zagl=50,time_of_day_24=i+6.5),levels=levels,cmap=py.cm.viridis)
        axs[1,i].set_title(str(i+6.5)+'LT',fontsize=10)
        if i == 0:
                axs[1,i].set_ylabel('Latitude',fontsize=8)
for i in range(6):
        cs = axs[2,i].contourf(DDS_MY24.lon,DDS_MY24.lat,DDS_MY24.wpd_diurn_ave_MY24.sel(zagl=50,time_of_day_24=i+12.5),levels=levels,cmap=py.cm.viridis)
        axs[2,i].set_title(str(i+12.5)+'LT',fontsize=10)
        if i == 0:
                axs[2,i].set_ylabel('Latitude',fontsize=8)

for i in range(6):
        cs = axs[3,i].contourf(DDS_MY24.lon,DDS_MY24.lat,DDS_MY24wpd_diurn_ave_MY24.sel(zagl=50,time_of_day_24=i+18.5),levels=levels,cmap=py.cm.viridis)
...
for i in range(6):
        cs = axs[0,i].contourf(DDS_MY24.lon,DDS_MY24.lat,DDS_MY24.swflx_diurn_ave_MY24.sel(time_of_day_24=i+0.5),levels=levels_swflx,cmap=py.cm.viridis)
        axs[0,i].set_title(str(i+0.5)+'LT',fontsize=10)
        if i == 0:
                axs[0,i].set_ylabel('Latitude',fontsize=8)
                axs[0,i].xaxis.set_major_locator(MultipleLocator(60))
                ...
                axs[0,i].set_yticklabels(['','-60','','0','','60',''])
for i in range(6):
        cs = axs[1,i].contourf(DDS_MY24.lon,DDS_MY24.lat,DDS_MY24.swflx_diurn_ave_MY24.sel(time_of_day_24=i+6.5),levels=levels_swflx,cmap=py.cm.viridis)
        axs[1,i].set_title(str(i+6.5)+'LT',fontsize=10)
        if i == 0:
                axs[1,i].set_ylabel('Latitude',fontsize=8)
for i in range(6):
        cs = axs[2,i].contourf(DDS_MY24.lon,DDS_MY24.lat,DDS_MY24.swflx_diurn_ave_MY24.sel(time_of_day_24=i+12.5),levels=levels_swflx,cmap=py.cm.viridis)
        axs[2,i].set_title(str(i+12.5)+'LT',fontsize=10)
        if i == 0:
                axs[2,i].set_ylabel('Latitude',fontsize=8)

for i in range(6):
        cs = axs[3,i].contourf(DDS_MY24.lon,DDS_MY24.lat,DDS_MY24.swflx_diurn_ave_MY24.sel(time_of_day_24=i+18.5),levels=levels_swflx,cmap=py.cm.viridis)
        axs[3,i].set_title(str(i+18.5)+'LT',fontsize=10)
        axs[3,i].set_xlabel('Longitude',fontsize=8)
        axs[3,i].set_xticklabels(['','60','','180','','300',''])
        if i == 0:
