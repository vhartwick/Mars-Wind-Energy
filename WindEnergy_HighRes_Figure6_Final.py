...
dataDIR = '/Users/vhartwic/Documents/codes/VHPlots/Data/fv3_2.0_windenergy/MY24_highres/MY24_highres_totalpercent_season.nc'
DDS_PCT5 = xr.open_dataset(dataDIR, decode_times=False)
...
# panel b - solar
cs = axs[1].contourf(DDS_PCT.lon, DDS_PCT.lat, (DDS_PCT2.count_solar2500/time)*100, cmap=py.cm.viridis, levels=levels)
cs2 = axs[1].contour(DDS_PCT.lon, DDS_PCT.lat, (DDS_PCT2.count_solar2500/time)*100, levels=levels, colors='k')
py.clabel(cs2, fontsize=9,inline=1, fmt='%1.0f')
axs[1].set_title('(B) Solar, $\ 2500m^{2}$')
axs[1].set_xlabel('Longitude')

# panel c - total
cs = axs[2].contourf(DDS_PCT.lon, DDS_PCT.lat, (DDS_PCT2.count_total2500/time)*100, cmap=py.cm.viridis, levels=levels)
cs2 = axs[2].contour(DDS_PCT.lon, DDS_PCT.lat, (DDS_PCT2.count_total2500/time)*100, colors='k',levels=levels[::3])
py.clabel(cs2, fontsize=9,inline=1, fmt='%1.0f')
...
fig1 = ax4.contourf(DDS_PCT.lon, DDS_PCT.lat, (DDS_PCT2.count_total2500/time)*100, levels=level_lim, colors='#bbbbbb')
fig1 = ax4.contour(DDS_PCT.lon, DDS_PCT.lat, (DDS_PCT2.count_total2500/time)*100, levels=level_lim, colors='k')

fig2 = ax4.contourf(DDS_PCT.lon, DDS_PCT.lat, DDS_PCT5.percent_wind24_ls270*100, levels=levels, colors='#8a226a')
fig2 = ax4.contourf(DDS_PCT.lon, DDS_PCT.lat, DDS_PCT5.percent_wind24_ls90*100, levels=levels, colors='#f98e09')
fig2 = ax4.contourf(DDS_PCT.lon, DDS_PCT.lat, (DDS_PCT.count_wind24/time)*100, levels=levels, colors='#e45a31')
...
datafile = '/Users/vhartwic/Desktop/SWIM1-5_0180.png'
datafile2 = '/Users/vhartwic/Desktop/SWIM1-5_180360.png'
...
img=py.plot(lon_crater, lat_crater, 'o',color='#02d8e9',markersize=12, markeredgecolor='k',markeredgewidth=1.5)
img=py.plot(lon_new, lat_new, 'o', color='#c9ff27', markersize=12, markeredgecolor='k',markeredgewidth=1.5)
ax4.grid(b=None, which='major', axis='both')


ax4.add_patch(Rectangle((130,9),26,27,linewidth=4,edgecolor='w',facecolor='none'))
ax4.add_patch(Rectangle((2,-7),73,58,linewidth=4,edgecolor='w',facecolor='none'))
