...
tmp_MY24 = DDS_MY24.wpd.mean('time_of_day_24')
tmp2_MY24 = DDS_MY24.swflx.mean('time_of_day_24')
...
#Send out Data
var1 = xr.DataArray(tmp_MY24, coords={'lon':DDS_MY24.lon, 'lat':DDS_MY24.lat, 'time':DDS_MY24.time, 'zagl':DDS_MY24.zagl},dims=['time','zagl','lat','lon'])
var1.name = 'diurn_wpd_MY24'

var2 = xr.DataArray(tmp2_MY24, coords={'lat':DDS_MY24.lat,'time':DDS_MY24.time},dims=['time','lat'])
var2.name = 'zonal_diurn_swflx_MY24'
